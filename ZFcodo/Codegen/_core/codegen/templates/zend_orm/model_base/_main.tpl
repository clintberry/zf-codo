<template OverwriteFlag="true" DocrootFlag="false" DirectorySuffix="" TargetDirectory="<%= __MODEL_GEN__ %>" TargetFileName="<%= $objTable->FileName %>.php"/>
<?php
	/**
...
<%@ property_comments('objTable'); %>
	 */
	class <%= $objTable->BaseClassName %> extends QBaseClass implements IteratorAggregate {
