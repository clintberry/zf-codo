<template OverwriteFlag="false" DocrootFlag="false" DirectorySuffix="" TargetDirectory="<%= __MODEL__ %>" TargetFileName="<%= $objTable->FileName %>.php"/>
<?php
	 ...
	 * 
	 */
	class <%= $objTable->ClassName %> extends <%= $objTable->BaseClassName %> {
		/**
