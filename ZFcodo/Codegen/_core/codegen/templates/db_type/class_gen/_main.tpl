<template OverwriteFlag="true" DocrootFlag="false" DirectorySuffix="" TargetDirectory="<%= __MODEL_GEN__ %>" TargetFileName="<%= $objTypeTable->FileName %>.php"/>
<?php
	/**
	 ...
	 */
	abstract class <%= $objTypeTable->BaseClassName %> extends QBaseClass {
