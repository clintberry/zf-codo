...
if (!defined('SERVER_INSTANCE')) {
	...
	switch (SERVER_INSTANCE) {
		...
		case 'prod':
			 ...
			 */
			define ('__DOCROOT__', '/home/justin/projects/cdze/trunk/');
			define ('__VIRTUAL_DIRECTORY__', '');
			define ('__SUBDIRECTORY__', '/library/Qcubed/codegen');
			...
			define ('__MODEL__', __DOCROOT__ . '/application/models' );
			define ('__MODEL_GEN__', __MODEL__ . '/Base' );
			...
			define ('__FORM_DRAFTS__', __DOCROOT__ . '/application/forms');
