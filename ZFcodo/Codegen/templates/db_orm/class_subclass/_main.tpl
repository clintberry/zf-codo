<template OverwriteFlag="false" DocrootFlag="false" DirectorySuffix="" TargetDirectory="<%= __MODEL__ %>" TargetFileName="<%= $objTable->ClassName %>.php"/>
<?php
	 ...
	 * 
	 */
	class Model_<%= $objTable->ClassName %> extends Model_Base_<%= $objTable->ClassName %> {
		/**
